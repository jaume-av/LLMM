...
- **GET**: **Sol·licita dades d'un recurs específic**. Leds dades solen ser incloses a la URL com a paràmetres de consulta.
- **POST**:** Envia dades per a ser processades**. Estes dades es solen envoar a través del cos de la sol·licitud. És un mètode molt comí en els **formularis web**
