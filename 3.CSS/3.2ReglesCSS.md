...
<details> <summary><strong>1. Selecciona totes les etiquetes &lt;h2&gt;.</strong></summary> <p><strong>Selector:</strong> <code>h2</code></p> <p><strong>Línies seleccionades:</strong></p> ```html <h2 class="section-title">Sobre Nosaltres</h2> <h2 class="section-title">Serveis</h2> ``` </details> <details> <summary><strong>2. Selecciona l'element amb ID <code>services-section</code>.</strong></summary> <p><strong>Selector:</strong> <code>#services-section</code></p> <p><strong>Línies seleccionades:</strong></p> ```html <section id="services-section"> ``` </details> <details> <summary><strong>3. Selecciona totes les etiquetes amb la classe <code>menu-item</code>.</strong></summary> <p><strong>Selector:</strong> <code>.menu-item</code></p> <p><strong>Línies seleccionades:</strong></p> ```html <li class="menu-item"><a href="#home">Inici</a></li> <li class="menu-item"><a href="#about">Sobre nosaltres</a></li> <li class="menu-item active"><a href="#contact">Contacte</a></li> ``` </details> <details> <summary><strong>4. Selecciona només el tercer &lt;li&gt; dins del menú (&lt;ul&gt;).</strong></summary> <p><strong>Selector:</strong> <code>.menu-item:nth-of-type(3)</code></p> <p><strong>Línia seleccionada:</strong></p> ```html <li class="menu-item active"><a href="#contact">Contacte</a></li> ``` </details> <details> <summary><strong>5. Selecciona tots els enllaços (&lt;a&gt;) dins del menú (&lt;ul&gt;).</strong></summary> <p><strong>Selector:</strong> <code>.menu a</code></p> <p><strong>Línies seleccionades:</strong></p> ```html <a href="#home">Inici</a> <a href="#about">Sobre nosaltres</a> <a href="#contact">Contacte</a> ``` </details>