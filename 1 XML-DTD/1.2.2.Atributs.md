...
<style>
.dtd .tok-delim { color:#6b7280; }     /* <, >, <! ... gris */
.dtd .tok-kw    { color:#1d4ed8; font-weight:600; } /* ATTLIST - blau */
.dtd .tok-el    { color:#059669; font-weight:600; } /* nomElement - verd */
.dtd .tok-attr  { color:#7c3aed; font-weight:600; } /* nomAtribut - morat */
.dtd .tok-type  { color:#ea580c; font-weight:600; } /* tipusAtribut - taronja */
.dtd .tok-def   { color:#0891b2; font-weight:600; } /* valorInicialAtribut - blau clar */
</style>

<pre class="dtd"><code>
<span class="tok-delim">&lt;!</span><span class="tok-kw">ATTLIST</span> <span class="tok-el">nomElement</span> <span class="tok-attr">nomAtribut</span> <span class="tok-type">tipusAtribut</span> <span class="tok-def">valorInicialAtribut</span> <span class="tok-delim">&gt;</span>
</code></pre>

<p><strong>On:</strong></p>

<ol>
  <li><span class="tok-delim">&lt;!</span><span class="tok-kw">ATTLIST</span> : Declaració de marca per a un atribut o llista d'atributs.</li>
  <li><span class="tok-el">nomElement</span> : Identificador de l'element al que s'aplica l'atribut.</li>
  <li><span class="tok-attr">nomAtribut</span> : Nom de l'atribut.</li>
  <li><span class="tok-type">tipusAtribut</span> : Tipus.</li>
  <li><span class="tok-def">valorInicialAtribut</span> : Valor per defecte.</li>
</ol>
