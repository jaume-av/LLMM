...
<a href="/3.CSS/3.4-Overflow.html" target="_blank">Demostració Overflow</a>


ooooooooooooo

[Demostració Overflow](/3.CSS/3.4-Overflow.html){:target="_blank"}


i ara:

[Demostració Overflow]({{ "/3.CSS/3.4-Overflow.html" | relative_url }}){:target="_blank"}
