...
Com puc posar en markdown i just the docs este text comentat que no es renderitze?

perfecte—ací tens la versió demanada: **sense `tok-delim`**, amb **`<ul>`** i amb classes **`element`**, **`atribut`**, **`tipus`** i **`valoratribut`**.

```html
<style>
/* paleta i classes noves */
.dtd .kw            { color:#1d4ed8; font-weight:600; }  /* ATTLIST */
...
<!-- línia DTD acolorida (sense delimitadors) -->
<pre class="dtd"><code>
<span class="kw">ATTLIST</span> <span class="element">nomElement</span> <span class="atribut">nomAtribut</span> <span class="tipus">tipusAtribut</span> <span class="valoratribut">valorInicialAtribut</span>
</code></pre>

<p><strong>On:</strong></p>

<ul class="dtd">
  <li><span class="kw">ATTLIST</span> : Declaració de marca per a un atribut o llista d'atributs.</li>
